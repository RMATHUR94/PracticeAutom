...
//				.click();
		...
		List<WebElement> servicesView = driver.findElements(By.xpath("//div[@class='mantine-Container-root mantine-a3uu5s']//button[@type='button']"));
		
		System.out.println(servicesView.size());
		
		//div[@class='mantine-Paper-root mantine-1g7sbpa']
		
		List<WebElement> ServiceBox = driver.findElements(By.xpath("//div[@class='mantine-Paper-root mantine-1g7sbpa']"));
		
		System.out.println(ServiceBox.size());
		
		List<WebElement> NameOfService = driver.findElements(By.xpath("//div[@class='mantine-Paper-root mantine-1g7sbpa']//h3"));
		  ...
		  for(int k=0;k<NameOfService.size();k++)
	         {
				...
				{
					WebElement elementk = driver.findElements(By.xpath("//div[@class='mantine-Container-root mantine-a3uu5s']//button[@type='button']")).get(k);
...
//		driver.findElement(By.cssSelector("#mantine-n8q54uuny")).sendKeys("Abc street");
		...
		while(!monthFound)
		{
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[normalize-space()='September 2023']")));
			...
			{
				WebElement CalendarNextbtn = driver.findElement(By.xpath("//button[@data-next='true']//*[name()='svg']"));
